...
<head>
    <meta charset="utf-8"/>
    <meta name="description" content="{{ \App\Models\Setting::find(2)->value }}"/>
    <meta name="keywords" content="{{ \App\Models\Setting::find(3)->value }}"/>
    <meta name="viewport" content="width=device-width, initial-scale=1"/>
    <meta name="csrf-token" content="{{ csrf_token() }}">

    <title>{!! !empty(__(theme()->getOption('page', 'title'))) ? __(theme()->getOption('page', 'title')).' | '.\App\Models\Setting::find(1)->value : \App\Models\Setting::find(1)->value !!}</title>

    <link rel="shortcut icon" href="{{ asset(\App\Models\Setting::find(8)->value) }}"/>
    {{-- begin::Fonts --}}
    {{ theme()->includeFonts() }}
    {{-- end::Fonts --}}

        ...
        <div
            ...
            <div class="d-flex flex-center flex-column flex-column-fluid p-10 pb-lg-20">
                ...
                <a href="{{ $theme->getPageUrl('') }}" class="mb-12">
                    <img alt="Logo" src="{{ asset($logoFileName) }}" class="h-45px"/>
                </a>
                <!--end::Logo-->
            ...
            <div class="d-flex flex-center flex-column-auto p-10">
                ...
                <div class="d-flex align-items-center fw-bold fs-6">
                    ...
                    <a href="{{ $theme->getOption('general', 'contact') }}" class="text-muted text-hover-primary px-2">{{ __('Support') }}</a>

                    <a href="{{ $theme->getOption('product', 'purchase') }}" class="text-muted text-hover-primary px-2">{{ __('Contact Us') }}</a>
                </div>
                <!--end::Links-->
            </div>
            <!--end::Footer-->

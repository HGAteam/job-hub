                     ...
                     <tr>
                        <td align="left" valign="top">
                           ...
                           <a href="#" target="_blank" style="display: block; max-width: 128px;">
                              <img src="https://colombres-garmendia.com/img/logo2.png" alt="img" width="128" border="0" style="display: block; width: 128px;" />
                           </a>
                     ...
                     <tr>
                        <td align="left" valign="top">
                           <font face="'Source Sans Pro', sans-serif" color="#1a1a1a" style="font-size: 52px; line-height: 60px; font-weight: 300; letter-spacing: -1.5px;">
                              <span style="font-family: 'Source Sans Pro', Arial, Tahoma, Geneva, sans-serif; color: #1a1a1a; font-size: 52px; line-height: 60px; font-weight: 300; letter-spacing: -1.5px;">Formulario de contacto web</span>
                           </font>
                           ...
                           <font face="'Source Sans Pro', sans-serif" color="#585858" style="font-size: 24px; line-height: 32px;">
                              ...
                              Contacto:&nbsp;{{$msg['contact']}}   <br>
                              Email:&nbsp;{{$msg['email']}} <br><br>
                              Mensaje:&nbsp;{{$msg['message']}}
                              </span>
                           </font>

                           <div style="height: 33px; line-height: 33px; font-size: 31px;">&nbsp;</div>
                           <table class="mob_btn" cellpadding="0" cellspacing="0" border="0" style="background: #2F3385 ; border-radius: 4px;">
                              <tr>
                                 <td align="center" valign="top">
                                    <a href="mailto:{{$msg['email']}}" target="_blank" style="display: block; border: 1px solid #2F3385 ; border-radius: 4px; padding: 12px 23px; font-family: 'Source Sans Pro', Arial, Verdana, Tahoma, Geneva, sans-serif; color: #ffffff; font-size: 20px; line-height: 30px; text-decoration: none; white-space: nowrap; font-weight: 600;">
                                       <font face="'Source Sans Pro', sans-serif" color="#ffffff" style="font-size: 20px; line-height: 30px; text-decoration: none; white-space: nowrap; font-weight: 600;">
                                          <span style="font-family: 'Source Sans Pro', Arial, Verdana, Tahoma, Geneva, sans-serif; color: #ffffff; font-size: 20px; line-height: 30px; text-decoration: none; white-space: nowrap; font-weight: 600;">Responder</span>
                                       </font>
                                    </a>
                                 </td>
                              </tr>
                                 ...
                                 <tr>
                                    <td align="center" valign="top">
                                       ...
                                       <div style="display: block; max-width: 50px;">
                                          <img src="https://colombres-garmendia.com/img/logo2.png" alt="img" width="50" border="0" style="display: block; width: 50px;" />
                                       </div>
                                    </td>
                                 </tr>
                              </table>
                                 ...
                                 <tr>
                                    ...
                                    <td class="mob_center" align="left" valign="top">
                                       ...
                                       <font face="'Source Sans Pro', sans-serif" color="#000000" style="font-size: 19px; line-height: 23px; font-weight: 600;">
                                          <span style="font-family: 'Source Sans Pro', Arial, Tahoma, Geneva, sans-serif; color: #000000; font-size: 19px; line-height: 23px; font-weight: 600;">Formulario de contacto</span>
                                       </font>
                                       ...
                                       <font face="'Source Sans Pro', sans-serif" color="#7f7f7f" style="font-size: 19px; line-height: 23px;">
                                          <span style="font-family: 'Source Sans Pro', Arial, Tahoma, Geneva, sans-serif; color: #7f7f7f; font-size: 19px; line-height: 23px;">ignacion@colombresgarmendia.com</span>
                                       </font>
                                    </td>
                                    <td width="18" style="width: 18px; max-width: 18px; min-width: 18px;">&nbsp;</td>
                                 </tr>

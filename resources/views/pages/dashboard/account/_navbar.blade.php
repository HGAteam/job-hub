@php
    $nav = array(
        ...
        array('title' => trans('Settings'), 'view' => 'home/account/settings'),
        ...
        <div class="d-flex flex-wrap flex-sm-nowrap mb-3">
            ...
            <div class="me-7 mb-4">
                <div class="symbol symbol-200px symbol-fixed position-relative">
                    <img src="{{ auth()->user()->info->avatar_url }}" alt="image" class="h-100"/>
            ...
            <div class="flex-grow-1">
                ...
                <div class="d-flex justify-content-between align-items-start flex-wrap mb-2">
                    ...
                    <div class="d-flex flex-column">
                        ...
                        <div class="d-flex flex-wrap fw-bold fs-6 mb-4 pe-2">
                            ...
                            {{-- <a href="#" class="d-flex align-items-center text-gray-400 text-hover-primary me-5 mb-2">
                                ...
                                {{ auth()->user()->info->country }}, {{ auth()->user()->info->state }}, {{ auth()->user()->info->city }}
                            </a> --}}
                        ...
                        <span class="fw-bolder fs-6 me-2">
                            {{ auth()->user()->info->phone }}

                            @if(auth()->user()->info->phone)
                        ...
                        <!--begin::Label-->
                        <label class="col-lg-6 fw-bold text-muted">{{ __('Mobile') }}</label>
                        <!--end::Label-->
                        <!--begin::Col-->
                        <div class="col-lg-8 fv-row">
                            @if (auth()->user()->mobile)
                            <span class="fw-bold fs-6">{{ auth()->user()->mobile }}</span>
                    ...
                    <div class="d-flex my-4">
                        <!--begin::Action-->
                        <a href="{{ theme()->getPageUrl('home/account/settings') }}" class="btn btn-primary align-self-center">{{ __('Edit Profile') }}</a>
                        <!--end::Action-->
                    </div>
                    <!--end::Actions-->
                </div>

...
<div class="card {{ $class }}">
    ...
    <div id="kt_account_profile_details" class="collapse">
        ...
        <form id="kt_account_profile_details_form" class="form" method="POST"
            action="{{ route('account.settings.update') }}" enctype="multipart/form-data">
            @csrf
            @method('PUT')
            <!--begin::Card body-->
            <div class="card-body border-top p-9">
                ...
                <div class="row mb-6">
                    ...
                    <div class="col-lg-8">
                        ...
                        <div class="image-input image-input-outline {{ isset($info) && $info->avatar ? '' : 'image-input-empty' }}"
                            ...
                            <div class="image-input-wrapper w-175px"
                                style="background-position: center center; background-image: {{ isset($info) && $info->avatar ? 'url(' . asset($info->avatar) . ')' : 'none' }};">
                            </div>
                        ...
                        <!--end::Image input-->
                        <h5 class="font-weight-bold mt-3">dimensiones óptimas: 990 × 660 px</h5>
                        <!--begin::Hint-->
                        <div class="form-text">
                            {{ __('Allowed file types') }}: png, jpg, jpeg.
                        </div>
                        <!--end::Hint-->
                    </div>
                    <!--end::Col-->
                ...
                <div class="row mb-6">
                    <!--begin::Label-->
                    <label class="col-lg-4 col-form-label fw-bold fs-6">{{ __('Mobile') }}</label>
                    <!--end::Label-->

                    <!--begin::Col-->
                    <div class="col-lg-8 fv-row">
                        <input type="text" name="mobile" class="form-control form-control-lg form-control-solid"
                            placeholder="{{ __('Mobile') }}" value="{{ old('mobile', $info->mobile ?? '') }}" />
                    </div>
                    <!--end::Col-->
                </div>
                <!--end::Input group-->

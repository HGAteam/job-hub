        ...
        <div class="card-header align-items-center py-5 gap-2 gap-md-5">
            ...
            <div class="card-title">
                ...
                <div class="d-flex align-items-center position-relative my-1">
                    ...
                    <input type="text" data-kt-ecommerce-order-filter="search" class="form-control form-control-solid w-250px ps-14" placeholder="{{__('Search Order')}}" />
                </div>
                <!--end::Search-->
            </div>
            <!--end::Card title-->
            ...
            <div class="card-toolbar flex-row-fluid justify-content-end gap-5">
                ...
                <div class="input-group w-250px">
                    <input class="form-control form-control-solid rounded rounded-end-0" placeholder="{{__('Pick date range')}}" id="kt_ecommerce_sales_flatpickr" />
                ...
                <div class="w-100 mw-150px">
                    <!--begin::Select2-->
                    <select class="form-select form-select-solid" data-control="select2" data-hide-search="true" data-placeholder="{{__('Status')}}" data-kt-ecommerce-order-filter="status">
                        <option></option>
                ...
                <!--begin::Add product-->
                <a href="{{route('shop.sales.orders.create')}}" class="btn btn-primary">{{__('Add Order')}}</a>
                <!--end::Add product-->
            </div>
            <!--end::Card toolbar-->
        </div>
            ...
            <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_ecommerce_sales_table">
                ...
                <thead>
                    ...
                    <tr class="text-start text-gray-400 fw-bolder fs-7 text-uppercase gs-0">
                        ...
                        <th class="text-end min-w-100px">{{__('Date Added')}}</th>
                        <th class="text-end min-w-100px">{{__('Date Modified')}}</th>

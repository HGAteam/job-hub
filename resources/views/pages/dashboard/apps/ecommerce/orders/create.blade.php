...
<form id="kt_ecommerce_edit_order_form" class="form d-flex flex-column flex-lg-row" data-kt-redirect="../../demo1/dist/apps/ecommerce/sales/listing.html">
    ...
    <div class="d-flex flex-column flex-lg-row-fluid gap-7 gap-lg-10">
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex align-items-center" data-kt-ecommerce-edit-order-filter="product" data-kt-ecommerce-edit-order-id="product_1">
                                        ...
                                        <div class="ms-5">
                                            <!--begin::Title-->
                                            <a href="#edit-product.html" class="text-gray-800 text-hover-primary fs-5 fw-bolder">Product 1</a>
                                            <!--end::Title-->
                                            <!--begin::Price-->
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex align-items-center" data-kt-ecommerce-edit-order-filter="product" data-kt-ecommerce-edit-order-id="product_2">
                                        ...
                                        <div class="ms-5">
                                            <!--begin::Title-->
                                            <a href="#edit-product.html" class="text-gray-800 text-hover-primary fs-5 fw-bolder">Product 2</a>
                                            <!--end::Title-->
                                            <!--begin::Price-->
                                            <div class="fw-bold fs-7">Price: $
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex align-items-center" data-kt-ecommerce-edit-order-filter="product" data-kt-ecommerce-edit-order-id="product_3">
                                        ...
                                        <div class="ms-5">
                                            <!--begin::Title-->
                                            <a href="#edit-product.html" class="text-gray-800 text-hover-primary fs-5 fw-bolder">Product 3</a>
                                            <!--end::Title-->
                                            <!--begin::Price-->
                                            <div class="fw-bold fs-7">Price: $
                                            ...
                                            <!--end::Price-->
                                            <!--begin::SKU-->
                                            <div class="text-muted fs-7">SKU: 04809005</div>
                                            <!--end::SKU-->
                                        </div>
                                    </div>
                                </td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex align-items-center" data-kt-ecommerce-edit-order-filter="product" data-kt-ecommerce-edit-order-id="product_4">
                                        ...
                                        <div class="ms-5">
                                            <!--begin::Title-->
                                            <a href="#edit-product.html" class="text-gray-800 text-hover-primary fs-5 fw-bolder">Product 4</a>
                                            <!--end::Title-->
                                            <!--begin::Price-->
                                            <div class="fw-bold fs-7">Price: $
                                            ...
                                            <!--end::Price-->
                                            <!--begin::SKU-->
                                            <div class="text-muted fs-7">SKU: 01527009</div>
                                            <!--end::SKU-->
                                        </div>
                                    </div>
                                </td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex align-items-center" data-kt-ecommerce-edit-order-filter="product" data-kt-ecommerce-edit-order-id="product_5">
                                        ...
                                        <div class="ms-5">
                                            <!--begin::Title-->
                                            <a href="#edit-product.html" class="text-gray-800 text-hover-primary fs-5 fw-bolder">Product 5</a>
                                            <!--end::Title-->
                                            <!--begin::Price-->
                                            <div class="fw-bold fs-7">Price: $
                                            <span data-kt-ecommerce-edit-order-filter="price">117.00</span></div>
                                            <!--end::Price-->
                                            <!--begin::SKU-->
                                            <div class="text-muted fs-7">SKU: 03979007</div>
                                            <!--end::SKU-->
                                        </div>
                                    </div>
                                </td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex align-items-center" data-kt-ecommerce-edit-order-filter="product" data-kt-ecommerce-edit-order-id="product_6">
                                        ...
                                        <div class="ms-5">
                                            <!--begin::Title-->
                                            <a href="#edit-product.html" class="text-gray-800 text-hover-primary fs-5 fw-bolder">Product 6</a>
                                            <!--end::Title-->
                                            <!--begin::Price-->
                                            <div class="fw-bold fs-7">Price: $
                                            ...
                                            <!--end::Price-->
                                            <!--begin::SKU-->
                                            <div class="text-muted fs-7">SKU: 03783001</div>
                                            <!--end::SKU-->
                                        </div>
                                    </div>
                                </td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex align-items-center" data-kt-ecommerce-edit-order-filter="product" data-kt-ecommerce-edit-order-id="product_7">
                                        ...
                                        <div class="ms-5">
                                            <!--begin::Title-->
                                            <a href="#edit-product.html" class="text-gray-800 text-hover-primary fs-5 fw-bolder">Product 7</a>
                                            <!--end::Title-->
                                            <!--begin::Price-->
                                            <div class="fw-bold fs-7">Price: $
                                            ...
                                            <!--end::Price-->
                                            <!--begin::SKU-->
                                            <div class="text-muted fs-7">SKU: 04723004</div>
                                            <!--end::SKU-->
                                        </div>
                                    </div>
                                </td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex align-items-center" data-kt-ecommerce-edit-order-filter="product" data-kt-ecommerce-edit-order-id="product_8">
                                        ...
                                        <div class="ms-5">
                                            <!--begin::Title-->
                                            <a href="#edit-product.html" class="text-gray-800 text-hover-primary fs-5 fw-bolder">Product 8</a>
                                            <!--end::Title-->
                                            <!--begin::Price-->
                                            <div class="fw-bold fs-7">Price: $
                                            <span data-kt-ecommerce-edit-order-filter="price">128.00</span></div>
                                            <!--end::Price-->
                                            <!--begin::SKU-->
                                            <div class="text-muted fs-7">SKU: 04303007</div>
                                            <!--end::SKU-->
                                        </div>
                                    </div>
                                </td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex align-items-center" data-kt-ecommerce-edit-order-filter="product" data-kt-ecommerce-edit-order-id="product_9">
                                        ...
                                        <div class="ms-5">
                                            <!--begin::Title-->
                                            <a href="#edit-product.html" class="text-gray-800 text-hover-primary fs-5 fw-bolder">Product 9</a>
                                            <!--end::Title-->
                                            <!--begin::Price-->
                                            <div class="fw-bold fs-7">Price: $
                                            ...
                                            <!--end::Price-->
                                            <!--begin::SKU-->
                                            <div class="text-muted fs-7">SKU: 03372004</div>
                                            <!--end::SKU-->
                                        </div>
                                    </div>
                                </td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex align-items-center" data-kt-ecommerce-edit-order-filter="product" data-kt-ecommerce-edit-order-id="product_10">
                                        ...
                                        <div class="ms-5">
                                            <!--begin::Title-->
                                            <a href="#edit-product.html" class="text-gray-800 text-hover-primary fs-5 fw-bolder">Product 10</a>
                                            <!--end::Title-->
                                            <!--begin::Price-->
                                            <div class="fw-bold fs-7">Price: $
                                            ...
                                            <!--end::Price-->
                                            <!--begin::SKU-->
                                            <div class="text-muted fs-7">SKU: 01943006</div>
                                            <!--end::SKU-->
                                        </div>
                                    </div>
                                </td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex align-items-center" data-kt-ecommerce-edit-order-filter="product" data-kt-ecommerce-edit-order-id="product_11">
                                        ...
                                        <div class="ms-5">
                                            <!--begin::Title-->
                                            <a href="#edit-product.html" class="text-gray-800 text-hover-primary fs-5 fw-bolder">Product 11</a>
                                            <!--end::Title-->
                                            <!--begin::Price-->
                                            <div class="fw-bold fs-7">Price: $
                                            <span data-kt-ecommerce-edit-order-filter="price">167.00</span></div>
                                            <!--end::Price-->
                                            <!--begin::SKU-->
                                            <div class="text-muted fs-7">SKU: 04252004</div>
                                            <!--end::SKU-->
                                        </div>
                                    </div>
                                </td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex align-items-center" data-kt-ecommerce-edit-order-filter="product" data-kt-ecommerce-edit-order-id="product_12">
                                        ...
                                        <div class="ms-5">
                                            <!--begin::Title-->
                                            <a href="#edit-product.html" class="text-gray-800 text-hover-primary fs-5 fw-bolder">Product 12</a>
                                            <!--end::Title-->
                                            <!--begin::Price-->
                                            <div class="fw-bold fs-7">Price: $
                                            <span data-kt-ecommerce-edit-order-filter="price">273.00</span></div>
                                            <!--end::Price-->
                                            <!--begin::SKU-->
                                            <div class="text-muted fs-7">SKU: 02146005</div>
                                            <!--end::SKU-->
                                        </div>
                                    </div>
                                </td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex align-items-center" data-kt-ecommerce-edit-order-filter="product" data-kt-ecommerce-edit-order-id="product_13">
                                        ...
                                        <div class="ms-5">
                                            <!--begin::Title-->
                                            <a href="#edit-product.html" class="text-gray-800 text-hover-primary fs-5 fw-bolder">Product 13</a>
                                            <!--end::Title-->
                                            <!--begin::Price-->
                                            <div class="fw-bold fs-7">Price: $
                                            ...
                                            <!--end::Price-->
                                            <!--begin::SKU-->
                                            <div class="text-muted fs-7">SKU: 03128004</div>
                                            <!--end::SKU-->
                                        </div>
                                    </div>
                                </td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex align-items-center" data-kt-ecommerce-edit-order-filter="product" data-kt-ecommerce-edit-order-id="product_14">
                                        ...
                                        <div class="ms-5">
                                            <!--begin::Title-->
                                            <a href="#edit-product.html" class="text-gray-800 text-hover-primary fs-5 fw-bolder">Product 14</a>
                                            <!--end::Title-->
                                            <!--begin::Price-->
                                            <div class="fw-bold fs-7">Price: $
                                            <span data-kt-ecommerce-edit-order-filter="price">233.00</span></div>
                                            <!--end::Price-->
                                            <!--begin::SKU-->
                                            <div class="text-muted fs-7">SKU: 03917002</div>
                                            <!--end::SKU-->
                                        </div>
                                    </div>
                                </td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex align-items-center" data-kt-ecommerce-edit-order-filter="product" data-kt-ecommerce-edit-order-id="product_15">
                                        ...
                                        <div class="ms-5">
                                            <!--begin::Title-->
                                            <a href="#edit-product.html" class="text-gray-800 text-hover-primary fs-5 fw-bolder">Product 15</a>
                                            <!--end::Title-->
                                            <!--begin::Price-->
                                            <div class="fw-bold fs-7">Price: $
                                            ...
                                            <!--end::Price-->
                                            <!--begin::SKU-->
                                            <div class="text-muted fs-7">SKU: 02868001</div>
                                            <!--end::SKU-->
                                        </div>
                                    </div>
                                </td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex align-items-center" data-kt-ecommerce-edit-order-filter="product" data-kt-ecommerce-edit-order-id="product_16">
                                        ...
                                        <div class="ms-5">
                                            <!--begin::Title-->
                                            <a href="#edit-product.html" class="text-gray-800 text-hover-primary fs-5 fw-bolder">Product 16</a>
                                            <!--end::Title-->
                                            <!--begin::Price-->
                                            <div class="fw-bold fs-7">Price: $
                                            ...
                                            <!--end::Price-->
                                            <!--begin::SKU-->
                                            <div class="text-muted fs-7">SKU: 03429004</div>
                                            <!--end::SKU-->
                                        </div>
                                    </div>
                                </td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex align-items-center" data-kt-ecommerce-edit-order-filter="product" data-kt-ecommerce-edit-order-id="product_17">
                                        ...
                                        <div class="ms-5">
                                            <!--begin::Title-->
                                            <a href="#edit-product.html" class="text-gray-800 text-hover-primary fs-5 fw-bolder">Product 17</a>
                                            <!--end::Title-->
                                            <!--begin::Price-->
                                            <div class="fw-bold fs-7">Price: $
                                            ...
                                            <!--end::Price-->
                                            <!--begin::SKU-->
                                            <div class="text-muted fs-7">SKU: 04982005</div>
                                            <!--end::SKU-->
                                        </div>
                                    </div>
                                </td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex align-items-center" data-kt-ecommerce-edit-order-filter="product" data-kt-ecommerce-edit-order-id="product_18">
                                        ...
                                        <div class="ms-5">
                                            <!--begin::Title-->
                                            <a href="#edit-product.html" class="text-gray-800 text-hover-primary fs-5 fw-bolder">Product 18</a>
                                            <!--end::Title-->
                                            <!--begin::Price-->
                                            <div class="fw-bold fs-7">Price: $
                                            <span data-kt-ecommerce-edit-order-filter="price">21.00</span></div>
                                            <!--end::Price-->
                                            <!--begin::SKU-->
                                            <div class="text-muted fs-7">SKU: 01859008</div>
                                            <!--end::SKU-->
                                        </div>
                                    </div>
                                </td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex align-items-center" data-kt-ecommerce-edit-order-filter="product" data-kt-ecommerce-edit-order-id="product_19">
                                        ...
                                        <div class="ms-5">
                                            <!--begin::Title-->
                                            <a href="#edit-product.html" class="text-gray-800 text-hover-primary fs-5 fw-bolder">Product 19</a>
                                            <!--end::Title-->
                                            <!--begin::Price-->
                                            <div class="fw-bold fs-7">Price: $
                                            ...
                                            <!--end::Price-->
                                            <!--begin::SKU-->
                                            <div class="text-muted fs-7">SKU: 04588001</div>
                                            <!--end::SKU-->
                                        </div>
                                    </div>
                                </td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex align-items-center" data-kt-ecommerce-edit-order-filter="product" data-kt-ecommerce-edit-order-id="product_20">
                                        ...
                                        <div class="ms-5">
                                            <!--begin::Title-->
                                            <a href="#edit-product.html" class="text-gray-800 text-hover-primary fs-5 fw-bolder">Product 20</a>
                                            <!--end::Title-->
                                            <!--begin::Price-->
                                            <div class="fw-bold fs-7">Price: $
                                            ...
                                            <!--end::Price-->
                                            <!--begin::SKU-->
                                            <div class="text-muted fs-7">SKU: 02680006</div>
                                            <!--end::SKU-->
                                        </div>
                                    </div>
                                </td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex align-items-center" data-kt-ecommerce-edit-order-filter="product" data-kt-ecommerce-edit-order-id="product_21">
                                        ...
                                        <div class="ms-5">
                                            <!--begin::Title-->
                                            <a href="#edit-product.html" class="text-gray-800 text-hover-primary fs-5 fw-bolder">Product 21</a>
                                            <!--end::Title-->
                                            <!--begin::Price-->
                                            <div class="fw-bold fs-7">Price: $
                                            ...
                                            <!--end::Price-->
                                            <!--begin::SKU-->
                                            <div class="text-muted fs-7">SKU: 04185004</div>
                                            <!--end::SKU-->
                                        </div>
                                    </div>
                                </td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex align-items-center" data-kt-ecommerce-edit-order-filter="product" data-kt-ecommerce-edit-order-id="product_22">
                                        ...
                                        <div class="ms-5">
                                            <!--begin::Title-->
                                            <a href="#edit-product.html" class="text-gray-800 text-hover-primary fs-5 fw-bolder">Product 22</a>
                                            <!--end::Title-->
                                            <!--begin::Price-->
                                            <div class="fw-bold fs-7">Price: $
                                            <span data-kt-ecommerce-edit-order-filter="price">218.00</span></div>
                                            <!--end::Price-->
                                            <!--begin::SKU-->
                                            <div class="text-muted fs-7">SKU: 03228001</div>
                                            <!--end::SKU-->
                                        </div>
                                    </div>
                                </td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex align-items-center" data-kt-ecommerce-edit-order-filter="product" data-kt-ecommerce-edit-order-id="product_23">
                                        ...
                                        <div class="ms-5">
                                            <!--begin::Title-->
                                            <a href="#edit-product.html" class="text-gray-800 text-hover-primary fs-5 fw-bolder">Product 23</a>
                                            <!--end::Title-->
                                            <!--begin::Price-->
                                            <div class="fw-bold fs-7">Price: $
                                            <span data-kt-ecommerce-edit-order-filter="price">105.00</span></div>
                                            <!--end::Price-->
                                            <!--begin::SKU-->
                                            <div class="text-muted fs-7">SKU: 01356004</div>
                                            <!--end::SKU-->
                                        </div>
                                    </div>
                                </td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex align-items-center" data-kt-ecommerce-edit-order-filter="product" data-kt-ecommerce-edit-order-id="product_24">
                                        ...
                                        <div class="ms-5">
                                            <!--begin::Title-->
                                            <a href="#edit-product.html" class="text-gray-800 text-hover-primary fs-5 fw-bolder">Product 24</a>
                                            <!--end::Title-->
                                            <!--begin::Price-->
                                            <div class="fw-bold fs-7">Price: $
                                            ...
                                            <!--end::Price-->
                                            <!--begin::SKU-->
                                            <div class="text-muted fs-7">SKU: 03136004</div>
                                            <!--end::SKU-->
                                        </div>
                                    </div>
                                </td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex align-items-center" data-kt-ecommerce-edit-order-filter="product" data-kt-ecommerce-edit-order-id="product_25">
                                        ...
                                        <div class="ms-5">
                                            <!--begin::Title-->
                                            <a href="#edit-product.html" class="text-gray-800 text-hover-primary fs-5 fw-bolder">Product 25</a>
                                            <!--end::Title-->
                                            <!--begin::Price-->
                                            <div class="fw-bold fs-7">Price: $
                                            ...
                                            <!--end::Price-->
                                            <!--begin::SKU-->
                                            <div class="text-muted fs-7">SKU: 04547005</div>
                                            <!--end::SKU-->
                                        </div>
                                    </div>
                                </td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex align-items-center" data-kt-ecommerce-edit-order-filter="product" data-kt-ecommerce-edit-order-id="product_26">
                                        ...
                                        <div class="ms-5">
                                            <!--begin::Title-->
                                            <a href="#edit-product.html" class="text-gray-800 text-hover-primary fs-5 fw-bolder">Product 26</a>
                                            <!--end::Title-->
                                            <!--begin::Price-->
                                            <div class="fw-bold fs-7">Price: $
                                            <span data-kt-ecommerce-edit-order-filter="price">126.00</span></div>
                                            <!--end::Price-->
                                            <!--begin::SKU-->
                                            <div class="text-muted fs-7">SKU: 04317006</div>
                                            <!--end::SKU-->
                                        </div>
                                    </div>
                                </td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex align-items-center" data-kt-ecommerce-edit-order-filter="product" data-kt-ecommerce-edit-order-id="product_27">
                                        ...
                                        <div class="ms-5">
                                            <!--begin::Title-->
                                            <a href="#edit-product.html" class="text-gray-800 text-hover-primary fs-5 fw-bolder">Product 27</a>
                                            <!--end::Title-->
                                            <!--begin::Price-->
                                            <div class="fw-bold fs-7">Price: $
                                            <span data-kt-ecommerce-edit-order-filter="price">287.00</span></div>
                                            <!--end::Price-->
                                            <!--begin::SKU-->
                                            <div class="text-muted fs-7">SKU: 04826007</div>
                                            <!--end::SKU-->
                                        </div>
                                    </div>
                                </td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex align-items-center" data-kt-ecommerce-edit-order-filter="product" data-kt-ecommerce-edit-order-id="product_28">
                                        ...
                                        <div class="ms-5">
                                            <!--begin::Title-->
                                            <a href="#edit-product.html" class="text-gray-800 text-hover-primary fs-5 fw-bolder">Product 28</a>
                                            <!--end::Title-->
                                            <!--begin::Price-->
                                            <div class="fw-bold fs-7">Price: $
                                            <span data-kt-ecommerce-edit-order-filter="price">26.00</span></div>
                                            <!--end::Price-->
                                            <!--begin::SKU-->
                                            <div class="text-muted fs-7">SKU: 03699003</div>
                                            <!--end::SKU-->
                                        </div>
                                    </div>
                                </td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex align-items-center" data-kt-ecommerce-edit-order-filter="product" data-kt-ecommerce-edit-order-id="product_29">
                                        ...
                                        <div class="ms-5">
                                            <!--begin::Title-->
                                            <a href="#edit-product.html" class="text-gray-800 text-hover-primary fs-5 fw-bolder">Product 29</a>
                                            <!--end::Title-->
                                            <!--begin::Price-->
                                            <div class="fw-bold fs-7">Price: $
                                            <span data-kt-ecommerce-edit-order-filter="price">261.00</span></div>
                                            <!--end::Price-->
                                            <!--begin::SKU-->
                                            <div class="text-muted fs-7">SKU: 02722001</div>
                                            <!--end::SKU-->
                                        </div>
                                    </div>
                                </td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex align-items-center" data-kt-ecommerce-edit-order-filter="product" data-kt-ecommerce-edit-order-id="product_30">
                                        ...
                                        <div class="ms-5">
                                            <!--begin::Title-->
                                            <a href="#edit-product.html" class="text-gray-800 text-hover-primary fs-5 fw-bolder">Product 30</a>
                                            <!--end::Title-->
                                            <!--begin::Price-->
                                            <div class="fw-bold fs-7">Price: $
                                            <span data-kt-ecommerce-edit-order-filter="price">237.00</span></div>
                                            <!--end::Price-->
                                            <!--begin::SKU-->
                                            <div class="text-muted fs-7">SKU: 01364004</div>
                                            <!--end::SKU-->
                                        </div>
                                    </div>
                                </td>
        ...
        <div class="d-flex justify-content-end">
            <!--begin::Button-->
            <a href="#products.html" id="kt_ecommerce_edit_order_cancel" class="btn btn-light me-5">Cancel</a>
            <!--end::Button-->
            <!--begin::Button-->

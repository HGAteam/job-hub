        ...
        <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_customers_table">
            ...
            <tbody class="fw-bold text-gray-600">
                <tr>
                    ...
                    <img src="assets/media/svg/card-logos/mastercard.svg" class="w-35px me-3" alt="" />**** 6975</td>
                    <!--end::Payment method=-->
                    <!--begin::Date=-->
                ...
                <tr>
                    ...
                    <!--begin::Payment method=-->
                    <td data-filter="visa">
                    <img src="assets/media/svg/card-logos/visa.svg" class="w-35px me-3" alt="" />**** 5798</td>
                    <!--end::Payment method=-->
                    <!--begin::Date=-->
                ...
                <tr>
                    ...
                    <!--begin::Payment method=-->
                    <td data-filter="mastercard">
                    <img src="assets/media/svg/card-logos/mastercard.svg" class="w-35px me-3" alt="" />**** 5263</td>
                    <!--end::Payment method=-->
                    <!--begin::Date=-->
                ...
                <tr>
                    ...
                    <img src="assets/media/svg/card-logos/american-express.svg" class="w-35px me-3" alt="" />**** 8036</td>
                    <!--end::Payment method=-->
                    <!--begin::Date=-->
                ...
                <tr>
                    ...
                    <!--begin::Payment method=-->
                    <td data-filter="visa">
                    <img src="assets/media/svg/card-logos/visa.svg" class="w-35px me-3" alt="" />**** 4223</td>
                    <!--end::Payment method=-->
                    <!--begin::Date=-->
                ...
                <tr>
                    ...
                    <!--begin::Payment method=-->
                    <td data-filter="american_express">
                    <img src="assets/media/svg/card-logos/american-express.svg" class="w-35px me-3" alt="" />**** 4463</td>
                    <!--end::Payment method=-->
                    <!--begin::Date=-->
                ...
                <tr>
                    ...
                    <!--begin::Payment method=-->
                    <td data-filter="mastercard">
                    <img src="assets/media/svg/card-logos/mastercard.svg" class="w-35px me-3" alt="" />**** 5311</td>
                    <!--end::Payment method=-->
                    <!--begin::Date=-->
                ...
                <tr>
                    ...
                    <!--begin::Payment method=-->
                    <td data-filter="american_express">
                    <img src="assets/media/svg/card-logos/american-express.svg" class="w-35px me-3" alt="" />**** 7658</td>
                    <!--end::Payment method=-->
                    <!--begin::Date=-->
                ...
                <tr>
                    ...
                    <!--begin::Payment method=-->
                    <td data-filter="visa">
                    <img src="assets/media/svg/card-logos/visa.svg" class="w-35px me-3" alt="" />**** 6730</td>
                    <!--end::Payment method=-->
                    <!--begin::Date=-->
                ...
                <tr>
                    ...
                    <!--begin::Payment method=-->
                    <td data-filter="visa">
                    <img src="assets/media/svg/card-logos/visa.svg" class="w-35px me-3" alt="" />**** 8081</td>
                    <!--end::Payment method=-->
                    <!--begin::Date=-->
                ...
                <tr>
                    ...
                    <!--begin::Payment method=-->
                    <td data-filter="mastercard">
                    <img src="assets/media/svg/card-logos/mastercard.svg" class="w-35px me-3" alt="" />**** 3201</td>
                    <!--end::Payment method=-->
                    <!--begin::Date=-->
                ...
                <tr>
                    ...
                    <!--begin::Payment method=-->
                    <td data-filter="american_express">
                    <img src="assets/media/svg/card-logos/american-express.svg" class="w-35px me-3" alt="" />**** 3160</td>
                    <!--end::Payment method=-->
                    <!--begin::Date=-->

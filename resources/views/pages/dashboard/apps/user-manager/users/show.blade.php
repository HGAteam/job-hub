                ...
                <div class="card-body">
                    ...
                    <div class="d-flex flex-center flex-column py-5">
                        ...
                        <div class="symbol symbol-100px symbol-circle mb-7">
                            <img src="{{ $user->info->avatar_url }}" alt="{{ $user->name }}" />
                        </div>
                        <!--end::Avatar-->
                        <!--begin::Name-->
                        <a href="#"
                    ...
                    <div class="d-flex flex-stack fs-4 py-3">
                        <div class="fw-bold rotate collapsible" data-bs-toggle="collapse" href="#kt_user_view_details"
                            ...
                            <span class="ms-2 rotate-180">
                                <!--begin::Svg Icon-->
                                {!! theme()->getSvgIcon('icons/duotune/arrows/arr072.svg', 'svg-icon svg-icon-3') !!}
                                <!--end::Svg Icon-->
                            </span>
                        </div>
                        <span data-bs-toggle="tooltip" data-bs-trigger="hover" title="{{ __('Edit user details') }}">
                            <a href="#" class="btn btn-sm btn-light-primary" data-bs-toggle="modal"
                                data-bs-target="#kt_modal_update_details">{{ __('Edit') }}</a>
                        </span>
                    </div>
                    <!--end::Details toggle-->
                    ...
                    <div id="kt_user_view_details" class="collapse show">
                        <div class="pb-5 fs-6">
                            ...
                            <div class="text-gray-600">ID-{{ str_pad($user->id, 8, '0', STR_PAD_LEFT) }}</div>
                            <!--begin::Details item-->
                            <!--begin::Details item-->
                            <div class="fw-bold mt-5">{{ __('Full Name') }}</div>
                            <div class="text-gray-600">
                                <a href="#" class="text-gray-600 text-hover-primary">{{ $user->name }}</a>
                            </div>
                            <!--begin::Details item-->
                            <!--begin::Details item-->
                            <div class="fw-bold mt-5">{{ __('Postion') }}</div>
                            <div class="text-gray-600">
                                <a href="#"
                                    class="text-gray-600 text-hover-primary">{{ $user->info->postion ? $user->info->postion : '--' }}</a>
                            </div>
                            <!--begin::Details item-->
                            <div class="fw-bold mt-5">{{ __('Phone') }}</div>
                            <div class="text-gray-600">
                                <a href="#"
                                    class="text-gray-600 text-hover-primary">{{ $user->phone ? $user->phone : '--' }}</a>
                            </div>
                            <!--begin::Details item-->
                            ...
                            <div class="text-gray-600">
                                {{ $user->info->address }},
                                <br />{{ $user->info->city ? $user->info->city . ', ' : '--' }}
                                {{ $user->info->state ? $user->info->state . ',' : '--' }}
                                @if ($user->info->country)
                                    <br />{{ $user->info->country ? collect(\App\Core\Data::getCountriesList())->get($user->info->country)['name'] : '--' }}
                                @endif
                                ...
                                <table class="table align-middle table-row-dashed fw-semibold text-gray-600 fs-6 gy-5"
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <!--end::Badge=-->
                                            <!--begin::Status=-->
                                            <td>POST /v1/invoices/in_8951_3326/payment</td>
                                            <!--end::Status=-->
                                            <!--begin::Timestamp=-->
                                        ...
                                        <tr>
                                            ...
                                            <!--end::Badge=-->
                                            <!--begin::Status=-->
                                            <td>POST /v1/invoices/in_8068_9460/payment</td>
                                            <!--end::Status=-->
                                            <!--begin::Timestamp=-->
                                        ...
                                        <tr>
                                            ...
                                            <!--end::Badge=-->
                                            <!--begin::Status=-->
                                            <td>POST /v1/invoice/in_1848_3823/invalid</td>
                                            <!--end::Status=-->
                                            <!--begin::Timestamp=-->
                                            <td class="pe-0 text-end min-w-200px">20 Dec 2022, 11:05 am</td>
                                            <!--end::Timestamp=-->
                                        </tr>
                                        <!--end::Table row-->
                                        <!--begin::Table row-->
                                        <tr>
                                            ...
                                            <!--end::Badge=-->
                                            <!--begin::Status=-->
                                            <td>POST /v1/invoices/in_8289_4474/payment</td>
                                            <!--end::Status=-->
                                            <!--begin::Timestamp=-->
                                            <td class="pe-0 text-end min-w-200px">15 Apr 2022, 8:43 pm</td>
                                            <!--end::Timestamp=-->
                                        </tr>
                                        <!--end::Table row-->
                                        <!--begin::Table row-->
                            ...
                            <table class="table align-middle table-row-dashed fs-6 text-gray-600 fw-semibold gy-5"
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <!--end::Event=-->
                                        <!--begin::Timestamp=-->
                                        <td class="pe-0 text-gray-600 text-end min-w-200px">20 Jun 2022, 11:05 am</td>
                                        <!--end::Timestamp=-->
                                    </tr>
                                    <!--end::Table row-->
                                    <!--begin::Table row-->
                        ...
                        <div class="d-flex flex-column scroll-y me-n7 pe-7" id="kt_modal_update_user_scroll"
                            ...
                            <div id="kt_modal_update_user_user_info" class="collapse show">
                                ...
                                <div class="row mb-6">
                                    ...
                                    <div class="col-lg-8">
                                        <!--begin::Image input-->
                                        <div class="image-input image-input-outline {{ isset($user->info) && $user->info->avatar ? '' : 'image-input-empty' }}"
                                            data-kt-image-input="true"
                                            style="background-image: url({{ asset(theme()->getMediaUrlPath() . 'avatars/blank.png') }})">
                                            <!--begin::Preview existing avatar-->
                                            <div class="image-input-wrapper w-125px h-125px"
                                                style="background-image: {{ isset($user->info) && $user->info->avatar ? 'url(' . asset($user->info->avatar) . ')' : 'none' }};">
                                            </div>
                                ...
                                <div class="row mb-6">
                                    <!--begin::Label-->
                                    <label
                                        class="col-lg-4 col-form-label required fw-bold fs-6">{{ __('Full Name') }}</label>
                                    <!--end::Label-->
                                    ...
                                    <div class="col-lg-8">
                                        ...
                                        <div class="row">
                                            <!--begin::Col-->
                                            <div class="col-lg-6 col-sm-6 fv-row">
                                ...
                                <div class="row mb-6">
                                    ...
                                    <div class="col-lg-8 fv-row">
                                        <input type="text" name="position"
                                            ...
                                            value="{{ old('position', $user->info->position ?? '') }}" />
                                    </div>
                                    <!--end::Col-->
                                </div>
                                <!--end::Input group-->
                                    ...
                                    <div class="fv-row col-lg-8">
                                        ...
                                        <select name="language" aria-label="{{ __('Select a Language') }}"
                                            ...
                                            @foreach (\App\Core\Data::getLanguagesList() as $key => $value)
                                                <option value="{{ $key }}"
                                                    {{ $key === old('language', $user->info->language ?? '') ? 'selected' : '' }}>
                                                    {{ $value['name'] }}</option>
                                            @endforeach
                                        </select>
                                        <!--end::Input-->
                            ...
                            <div class="fw-bolder fs-3 rotate collapsible mb-7" data-bs-toggle="collapse"
                                ...
                                aria-controls="kt_modal_update_user_address">{{ __('Address Details') }}
                                <span class="ms-2 rotate-180">
                                    <!--begin::Svg Icon-->
                                    {!! theme()->getSvgIcon('icons/duotune/arrows/arr072.svg', 'svg-icon svg-icon-3') !!}
                                    <!--end::Svg Icon-->
                            ...
                            <div id="kt_modal_update_user_address" class="collapse show">
                                ...
                                <div class="row g-9 mb-7">
                                    ...
                                    <div class="col-md-6 fv-row">
                                        ...
                                        <label class="fs-6 fw-bold mb-2">
                                            ...
                                            <i class="fas fa-exclamation-circle ms-1 fs-7" data-bs-toggle="tooltip"
                                                title="{{ __('State / Province of origination') }}"></i>
                                        </label>
                                        <!--end::Label-->
                                        <!--begin::Input-->
                                        <select name="state" aria-label="{{ __('Select State / Province') }}"
                                            data-control="select2"
                                            data-placeholder="{{ __('Select State / Province') }}..."
                                            class="form-select form-select-solid"
                                            data-dropdown-parent="#kt_modal_update_details">
                                            <option value="">{{ __('Select State / Province') }}...</option>
                                            @foreach (\App\Core\Data::getStatesList() as $key => $value)
                                                <option value="{{ $key }}"
                                                    {{ $key === old('state', $info->state ?? '') ? 'selected' : '' }}>
                                ...
                                <div class="row g-9 mb-7">
                                    ...
                                    <div class="col-md-4 fv-row">
                                        <!--begin::Label-->
                                        <label class="fs-6 fw-bold mb-2">{{ __('Post Code') }}</label>
                                        <!--end::Label-->
                                        <!--begin::Input-->
                                        <input class="form-control form-control-solid" placeholder=""
    ...
    <div class="modal fade" id="kt_modal_update_email" tabindex="-1" aria-hidden="true">
        ...
        <div class="modal-dialog modal-dialog-centered mw-650px">
            ...
            <div class="modal-content">
                ...
                <div class="modal-header">
                    <!--begin::Modal title-->
                    <h2 class="fw-bold">{{ __('Update Email Address') }}</h2>
                    <!--end::Modal title-->
                    <!--begin::Close-->
                    <div class="btn btn-icon btn-sm btn-active-icon-primary" data-kt-users-modal-action="close">
                        <!--begin::Svg Icon-->
                ...
                <div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
                    ...
                    <form id="kt_modal_update_email_form" class="form" action="#">
                        ...
                        <div
                            ...
                            <!--begin::Icon-->
                            <!--begin::Svg Icon-->
                            {!! theme()->getSvgIcon('icons/duotune/general/gen044.svg', 'svg-icon svg-icon-2tx svg-icon-primary me-4') !!}
                            <!--end::Svg Icon-->
                            <!--end::Icon-->
                            <!--begin::Wrapper-->
                            <div class="d-flex flex-stack flex-grow-1">
                                ...
                                <div class="fw-semibold">
                                    <div class="fs-6 text-gray-700">
                                        {{ __('Please note that a valid email address is required

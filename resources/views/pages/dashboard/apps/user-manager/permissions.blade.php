    ...
    <div class="card-header mt-6">
        ...
        <div class="card-title">
            ...
            <div class="d-flex align-items-center position-relative my-1 me-5">
                ...
                <!--end::Svg Icon-->
                <input type="text" data-kt-permissions-table-filter="search" class="form-control form-control-solid w-250px ps-15" placeholder="{{ __('Search Permissions')}}" />
            </div>
            <!--end::Search-->
        </div>
        <!--end::Card title-->
        ...
        <div class="card-toolbar">
            ...
            {!! theme()->getSvgIcon("icons/duotune/general/gen035.svg","svg-icon svg-icon-3") !!}
            <!--end::Svg Icon-->
            {{ __('Add Permission')}}
        </button>
            <!--end::Button-->
    ...
    <div class="modal-dialog modal-dialog-centered mw-650px">
        ...
        <div class="modal-content">
            ...
            <div class="modal-header">
                <!--begin::Modal title-->
                <h2 class="fw-bold">{{ __('Add a Permission')}}</h2>
                <!--end::Modal title-->
                <!--begin::Close-->
            ...
            <div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
                ...
                <form id="kt_modal_add_permission_form" class="form" action="#">
                    ...
                    <!--end::Input group-->
                    <!--begin::Disclaimer-->
                    <div class="text-gray-600">{{ __('Permission set as a')}}
                    <strong class="me-1">{{ __('Core Permission')}}</strong>{{ __('will be locked and')}}
                    <strong class="me-1">{{ __('not editable')}}</strong>{{ __('in future')}}</div>
                    <!--end::Disclaimer-->
                    <!--begin::Actions-->
                    <div class="text-center pt-15">
                        <button type="reset" class="btn btn-light me-3" data-kt-permissions-modal-action="cancel">{{__('Discard')}}</button>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
                ...
                <div class="notice d-flex bg-light-warning rounded border-warning border border-dashed mb-9 p-6">
                    ...
                    {!! theme()->getSvgIcon("icons/duotune/general/gen044.svg","svg-icon svg-icon-2tx svg-icon-warning me-4") !!}
                    <!--end::Svg Icon-->
                    <!--end::Icon-->
                    <!--begin::Wrapper-->
                    <div class="d-flex flex-stack flex-grow-1">
                        ...
                        <div class="fw-semibold">
                            ...
                            <strong class="me-1">{{ __('Warning')}}!</strong>{{ __("By editing the permission name, you might break the system permissions functionality. Please ensure you're absolutely certain before proceeding.")}}</div>
                        </div>
                        <!--end::Content-->
                    </div>
                    <!--end::Wrapper-->

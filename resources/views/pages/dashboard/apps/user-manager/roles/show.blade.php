                ...
                <div class="card-body pt-0">
                    ...
                    <div class="d-flex flex-column text-gray-600">
                        ...
                        <div class='d-flex align-items-center py-2'>
                            ...
                            <em>and {{ $role->permissions->count() - 10 }} more...</em>
                        </div>
                        @endif
                    </div>
                    <!--end::Permissions-->
                            ...
                            <form id="kt_modal_update_role_form" class="form" action="#">
                                ...
                                <div class="d-flex flex-column scroll-y me-n7 pe-7" id="kt_modal_update_role_scroll"
                                    ...
                                    <div class="fv-row mb-10">
                                        ...
                                        <!--end::Label-->
                                        <!--begin::Input-->
                                        <input class="form-control form-control-solid" placeholder="{{ __('Enter a new role name')}}"
                ...
                <div class="card-header pt-5">
                    ...
                    <div class="card-title">
                        <h2 class="d-flex align-items-center">Users Assigned
                            <span class="text-gray-600 fs-6 ms-1">(0)</span>
                        </h2>
                    </div>
                    <!--end::Card title-->
                    <!--begin::Card toolbar-->
                                    ...
                                    <div class="symbol symbol-circle symbol-50px overflow-hidden me-3">
                                        <a href="../../demo1/dist/apps/user-management/users/view.html">
                                            <div class="symbol-label">
                                                <img src="{{asset(theme()->getMediaUrlPath() . 'avatars/300-6.jpg')}}" alt="Emma Smith"
                                                    class="w-100" />
                                            </div>
                                        </a>
                                    </div>

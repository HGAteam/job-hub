@extends('layout.theme.default.master')
...
@section('content')
    <section class="section custom-section-background position-relative border-0 overflow-hidden m-0 p-0">
        <div class="position-absolute top-0 left-0 right-0 bottom-0 animated fadeIn" style="animation-delay: 600ms;">
            <div class="background-image-wrapper custom-background-style-1 position-absolute top-0 left-0 right-0 bottom-0 animated kenBurnsToRight"
                style="background-image: url({{asset('theme/default/img/backgrounds/background-1.jpg')}}); background-position: center right; animation-duration: 30s;">
            </div>
        </div>
                ...
                <div class="col-md-8 col-lg-6 col-xl-5">
                    <div class="overflow-hidden mb-1">
                        <h2 class="font-weight-bold text-color-grey text-4-5 line-height-2 line-height-sm-7 mb-0 appear-animation"
                            data-appear-animation="maskUp" data-appear-animation-delay="800">{{__('Learn about HGA Quick Boot solution')}}</h2>
                    </div>
                    <h1 class="text-color-dark font-weight-bold text-8 pb-2 mb-4 appear-animation"
                        data-appear-animation="fadeInUpShorter" data-appear-animation-delay="1100">{{ __('Our powerful tool for the fast creation of websites and web applications')}}</h1>
                    <a href="#" target="_blank"
                        class="btn btn-primary custom-btn-border-radius custom-btn-arrow-effect-1 font-weight-bold text-3 px-5 btn-py-3 appear-animation text-uppercase"
        ...
        <div class="container">
            <div class="row align-items-center justify-content-center">
                <div class="col-sm-9 col-md-12 col-lg-7 text-center text-lg-end mb-4 mb-lg-0">
                    <h2 class="font-weight-bold text-color-primary text-7 line-height-1 mb-1 appear-animation"
                        data-appear-animation="fadeInLeftShorterPlus" data-appear-animation-delay="1700">{{ __('We invite you to be part of our team of developers')}}</h2>
                    <p class="font-weight-bold text-4 mb-0 appear-animation" data-appear-animation="fadeInLeftShorterPlus"
                        data-appear-animation-delay="1900">{{ __('We invite you to join our team and make your contribution')}}</p>
                </div>
                <div class="col-lg-5 text-center text-lg-start ps-lg-4">
                    <a href="#"
                        class="btn btn-primary btn-outline custom-btn-border-radius font-weight-bold text-3 btn-px-5 btn-py-3 ms-lg-2 appear-animation text-uppercase"
                        data-appear-animation="fadeInLeftShorterPlus" data-appear-animation-delay="1500">{{ __('HGA Quick Boot Designers') }}</a>
                </div>
            </div>
        </div>
    </section>
            ...
            <div class="col-lg-6 pb-sm-4 pb-lg-0 mb-5 mb-lg-0">
                <div class="overflow-hidden">
                    <h2 class="font-weight-bold text-color-dark line-height-1 mb-0 appear-animation"
                        data-appear-animation="maskUp" data-appear-animation-delay="300">{{ __('Whether you are a web designer with UX/UI experience or not, this solution was created for you')}}</h2>
                </div>
                ...
                <p class="font-weight-light text-3-5 mb-4 appear-animation" data-appear-animation="fadeInUpShorter"
                    data-appear-animation-delay="450">Cras a elit sit amet leo accumsan volutpat. Suspendisse hendrerit
                    vehicula leo, vel efficitur felis ultrices non. Integer aliquet ullamcorper dolor, quis sollicitudin.
                </p>
                <p class="pb-1 mb-4 appear-animation" data-appear-animation="fadeInUpShorter"
                    data-appear-animation-delay="700">Cras a elit sit amet leo accumsan volutpat. Suspendisse hendrerit
                    vehicula leo, vel efficitur felis ultrices non. Integer aliquet ullamcorper dolor, quis sollicitudin.
                    Suspendisse hendrerit vehicula leo, vel efficitur felis ultrices non.</p>
                <div class="d-flex align-items-start align-items-sm-center flex-column flex-sm-row">
                    <a href="demo-auto-services-about-us.html"
                        ...
                        data-appear-animation="fadeInRightShorterPlus" data-appear-animation-delay="950">VIEW MORE</a>
                    <div class="feature-box align-items-center border border-top-0 border-end-0 border-bottom-0 custom-remove-mobile-xs-border-left ms-sm-4 ps-sm-4 appear-animation"
                        ...
                        <div class="feature-box-info line-height-2 ps-1">
                            ...
                            <strong class="text-4-5"><a href="tel:+1234567890"
                                    class="text-color-dark text-color-hover-primary text-decoration-none">+123 4567
                                    890</a></strong>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-10 col-md-9 col-lg-6 ps-lg-5 pe-5 appear-animation"
                ...
                <div class="position-relative">
                    <div data-plugin-float-element
                        ...
                        <img src="{{ asset('theme/default/img/generic-1.png') }}" class="img-fluid"
                            alt="" />
                    </div>
                    <div class="position-absolute transform3dxy-n50" style="top: 25%; left: 7%;">
                        <div data-plugin-float-element
                            ...
                            <img src="{{ asset('theme/default/img/generic-1-1.png') }}"
                                class="appear-animation" alt="" data-appear-animation="fadeInUpShorterPlus"
                    ...
                    <div class="position-absolute transform3dxy-n50 ms-5 pb-5 ms-xl-0" style="top: 32%; left: 85%;">
                        <div data-plugin-float-element
                            ...
                            <img src="{{ asset('theme/default/img/generic-1-2.png') }}"
                                class="appear-animation" alt="" data-appear-animation="fadeInRightShorterPlus"
                    ...
                    <div class="position-absolute transform3dxy-n50" style="top: 90%; left: 19%;">
                        <div data-plugin-float-element
                            ...
                            <img src="{{ asset('theme/default/img/generic-1-3.png') }}"
                                class="appear-animation" alt="" data-appear-animation="fadeInDownShorterPlus"
        ...
        <div class="row pb-2">
            <div class="col-lg-4 text-center px-lg-5 mb-5 mb-lg-0">
                <a href="demo-auto-services-services-detail.html" class="text-decoration-none">
                    <div class="custom-icon-box-style-1 appear-animation" data-appear-animation="fadeInRightShorterPlus"
                        data-appear-animation-delay="250" data-plugin-options="{'accY': -200}">
                        <div class="custom-icon-style-1 mb-4">
                            <img width="50" src="{{ asset('theme/default/img/icons/checklist.svg') }}"
                                alt="" data-icon
            ...
            <div class="col-lg-4 text-center px-lg-5 mb-5 mb-lg-0">
                <a href="demo-auto-services-services-detail.html" class="text-decoration-none">
                    <div class="custom-icon-box-style-1 appear-animation" data-appear-animation="fadeInRightShorterPlus"
                        data-appear-animation-delay="500" data-plugin-options="{'accY': -200}">
                        <div class="custom-icon-style-1 mb-4">
                            <img width="50" src="{{ asset('theme/default/img/icons/wheel-disk.svg') }}"
                                alt="" data-icon
                                data-plugin-options="{'onlySVG': true, 'extraClass': 'svg-fill-color-primary'}" />
                        </div>
                        <h3
            ...
            <div class="col-lg-4 text-center px-lg-5">
                <a href="demo-auto-services-services-detail.html" class="text-decoration-none">
                    <div class="custom-icon-box-style-1 appear-animation" data-appear-animation="fadeInRightShorterPlus"
                        data-appear-animation-delay="750" data-plugin-options="{'accY': -200}">
                        <div class="custom-icon-style-1 mb-4">
                            <img width="50" src="{{ asset('theme/default/img/icons/car-safe.svg') }}"
                                alt="" data-icon
                                data-plugin-options="{'onlySVG': true, 'extraClass': 'svg-fill-color-primary'}" />
                        </div>
                        <h3
    ...
    <section class="section custom-bg-color-grey-1 custom-background-size-1 position-relative overflow-hidden border-0 m-0"
        ...
        data-image-src="{{ asset('theme/default/img/backgrounds/background-2.jpg') }}">
        <svg class="custom-svg-background-1" version="1.1" xmlns="http:/www.w3.org/2000/svg"
            ...
            <path class="appear-animation" data-appear-animation="customLineAnim2" data-appear-animation-delay="500"
                data-appear-animation-duration="5s" data-plugin-options="{'accY': -400}" fill="none" stroke="#1C5FA8"
                ...
                <div class="col-lg-6">
                    <div class="overflow-hidden">
                        <h2 class="font-weight-bold text-color-dark line-height-3 mb-0 appear-animation"
                            data-appear-animation="maskUp" data-appear-animation-delay="250">Proudly Serving All Brands
                        </h2>
                    </div>
                    ...
                    <p class="font-weight-light text-3-5 pb-3 pe-5 me-md-5 me-lg-4 mb-4 appear-animation"
                        data-appear-animation="fadeInUpShorter" data-appear-animation-delay="500">Cras a elit sit amet leo
                        accumsan volutpat. Suspendisse hendrerit vehicula leo, vel efficitur felis ultrices non. Integer
    ...
    <div class="container py-5 my-5">
        <div class="row justify-content-center">
            <div class="col-lg-9 col-xl-8 text-center">
                <div class="overflow-hidden">
                    <h2 class="font-weight-bold text-color-dark line-height-1 mb-0 appear-animation"
                        data-appear-animation="maskUp" data-appear-animation-delay="250">Auto Services</h2>
                </div>
                ...
                <p class="font-weight-light text-3-5 mb-5 appear-animation" data-appear-animation="fadeInUpShorter"
                    data-appear-animation-delay="500">Cras a elit sit amet leo accumsan volutpat. Suspendisse hendrerit
                    vehicula leo, vel efficitur felis ultrices non. Integer aliquet ullamcorper dolor, quis sollicitudin.
                </p>
            </div>
        </div>
                ...
                <a href="demo-auto-services-services-detail.html" class="text-decoration-none">
                    <div
                        ...
                        <div class="thumb-info-wrapper">
                            <img src="{{ asset('theme/default/img/services/service-small-1.jpg') }}"
                                class="img-fluid" alt="">
                        </div>
            ...
            <div class="col-sm-6 col-lg-3 text-center mb-4 mb-lg-0">
                <a href="demo-auto-services-services-detail.html" class="text-decoration-none">
                    <div
                        class="custom-thumb-info-style-1 thumb-info thumb-info-no-borders thumb-info-no-borders-rounded thumb-info-lighten">
                        <div class="thumb-info-wrapper">
                            <img src="{{ asset('theme/default/img/services/service-small-2.jpg') }}"
                                class="img-fluid" alt="">
                        </div>
            ...
            <div class="col-sm-6 col-lg-3 text-center mb-4 mb-sm-0">
                <a href="demo-auto-services-services-detail.html" class="text-decoration-none">
                    <div
                        class="custom-thumb-info-style-1 thumb-info thumb-info-no-borders thumb-info-no-borders-rounded thumb-info-lighten">
                        <div class="thumb-info-wrapper">
                            <img src="{{ asset('theme/default/img/services/service-small-3.jpg') }}"
                                class="img-fluid" alt="">
                        </div>
            ...
            <div class="col-sm-6 col-lg-3 text-center">
                <a href="demo-auto-services-services-detail.html" class="text-decoration-none">
                    <div
                        class="custom-thumb-info-style-1 thumb-info thumb-info-no-borders thumb-info-no-borders-rounded thumb-info-lighten">
                        <div class="thumb-info-wrapper">
                            <img src="{{ asset('theme/default/img/services/service-small-4.jpg') }}"
                                class="img-fluid" alt="">
                        </div>
        ...
        <div class="row">
            <div class="col text-center">
                <a href="demo-auto-services-services.html"
                    class="btn btn-primary custom-btn-border-radius font-weight-bold text-3 btn-px-5 btn-py-3 appear-animation"
                    data-appear-animation="fadeInUpShorterPlus" data-appear-animation-delay="850">VIEW ALL SERVICES</a>
            </div>
        </div>
    </div>
        ...
        <div class="container pb-3 my-5">
            <div class="row justify-content-center pb-3 mb-4">
                <div class="col text-center">
                    ...
                    <p class="font-weight-bold text-3-5 mb-1">We are very proud of the service we provide and stand by
                        every product we carry.</p>
        ...
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-6 col-xl-7 text-center text-lg-start mb-4 mb-lg-0">
                    ...
                    <p class="font-weight-bold text-color-light text-4 opacity-7 mb-0">Make An Appointment Today With Our
                        Online Form</p>
                </div>
                <div class="col-lg-6 col-xl-5">
                    <div class="d-flex flex-column flex-lg-row align-items-center justify-content-between">
                        ...
                        <a href="demo-auto-services-appointment.html"
            ...
            <div class="row">
                <div class="col-6 col-md-3 px-0">
                    <a class="d-inline-block custom-img-thumbnail-style-1 img-thumbnail img-thumbnail-no-borders img-thumbnail-hover-icon rounded-0"
                        href="{{ asset('theme/default/img/generic/generic-square-1.jpg') }}">
                        <img class="img-fluid rounded-0"
                            src="{{ asset('theme/default/img/generic/generic-square-1.jpg') }}"
                            alt="" />
                    </a>
                </div>
                <div class="col-6 col-md-3 px-0">
                    <a class="d-inline-block custom-img-thumbnail-style-1 img-thumbnail img-thumbnail-no-borders img-thumbnail-hover-icon rounded-0"
                        href="{{ asset('theme/default/img/generic/generic-square-2.jpg') }}">
                        <img class="img-fluid rounded-0"
                            src="{{ asset('theme/default/img/generic/generic-square-2.jpg') }}"
                            alt="" />
                    </a>
                </div>
                <div class="col-6 col-md-3 px-0">
                    <a class="d-inline-block custom-img-thumbnail-style-1 img-thumbnail img-thumbnail-no-borders img-thumbnail-hover-icon rounded-0"
                        href="{{ asset('theme/default/img/generic/generic-square-3.jpg') }}">
                        <img class="img-fluid rounded-0"
                            src="{{ asset('theme/default/img/generic/generic-square-3.jpg') }}"
                            alt="" />
                    </a>
                </div>
                <div class="col-6 col-md-3 px-0">
                    <a class="d-inline-block custom-img-thumbnail-style-1 img-thumbnail img-thumbnail-no-borders img-thumbnail-hover-icon rounded-0"
                        href="{{ asset('theme/default/img/generic/generic-square-4.jpg') }}">
                        <img class="img-fluid rounded-0"
                            src="{{ asset('theme/default/img/generic/generic-square-4.jpg') }}"
                            alt="" />
                    </a>
                </div>
            </div>
    ...
    <div class="container py-5 my-5">
        <div class="row justify-content-center pb-3 mb-4">
            <div class="col-lg-9 col-xl-8 text-center">
                <div class="overflow-hidden">
                    <h2 class="font-weight-bold text-color-dark line-height-1 mb-0 appear-animation"
                        data-appear-animation="maskUp" data-appear-animation-delay="250">Frequently Asked Questions</h2>
                </div>
                <div class="d-inline-block custom-divider divider divider-primary divider-small my-3">
                    <hr class="my-0 appear-animation" data-appear-animation="customLineProgressAnim"
        ...
        <div class="row row-gutter-sm">
                ...
                <div class="accordion custom-accordion-style-1 appear-animation" data-appear-animation="fadeInUpShorter"
                    ...
                    <div class="card card-default">
                        ...
                        <div id="collapse1One" class="collapse" aria-labelledby="collapse1HeadingOne"
                            ...
                            <div class="card-body">
                                <p class="mb-0">Donec tellus massa, tristique sit amet condim vel, facilisis quis sapien.
                                    Praesent id enim sit amet odio vulputate eleifend in in tortor. Donec tellus massa,
                                    tristique sit amet condim vel, facilisis quis sapien. Praesent id enim sit amet odio
                                    vulputate eleifend in in tortor. Donec tellus massa, tristique sit amet condim vel,
                                    facilisis quis sapien.</p>
                            </div>
                        </div>
                    </div>
                    <div class="card card-default">
            ...
            <div class="col-md-4 col-lg-3 text-center text-md-start">
                <div class="appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="1000">
                    ...
                    <p class="pb-1 mb-2">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Lorem ipsum dolor sit
                        amet, consectetur adipiscing elit.</p>
                    <a href="demo-auto-services-about-us.html"
                        class="btn btn-primary custom-btn-border-radius font-weight-bold btn-px-5 py-3 mb-2">VIEW MORE</a>
                ...
                <div class="appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="1100">
                    ...
                    <a href="demo-auto-services-contact.html"
                        class="btn btn-primary custom-btn-border-radius font-weight-bold btn-px-5 py-3">CONTACT US</a>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="container">
            <div class="row justify-content-center pb-3 mb-4">
                <div class="col-lg-8 text-center">
                    <div class="overflow-hidden">
                        <h2 class="font-weight-bold text-color-dark line-height-1 mb-0 appear-animation"
                            data-appear-animation="maskUp" data-appear-animation-delay="250">Products For Sale</h2>
                    </div>
                    <div class="d-inline-block custom-divider divider divider-primary divider-small my-3">
                        <hr class="my-0 appear-animation" data-appear-animation="customLineProgressAnim"
                            data-appear-animation-delay="600">
                    ...
                    <p class="font-weight-light text-3-5 mb-0 appear-animation" data-appear-animation="fadeInUpShorter"
                        data-appear-animation-delay="500">Cras a elit sit amet leo accumsan volutpat. Suspendisse hendrerit
                        vehicula leo, vel efficitur felis ultrices non. Integer aliquet ullamcorper dolor, quis
                        sollicitudin.</p>
                </div>
            </div>
            <div class="products row row-gutter-sm mb-4 appear-animation" data-appear-animation="fadeInUpShorter"
                data-appear-animation-delay="750">
                            ...
                            <a href="shop-product-sidebar-left.html">
                                <div class="product-thumb-info-image bg-light">
                                    <img alt="" class="img-fluid"
                                        src="{{ asset('theme/default/img/products/product-1.jpg') }}">
                                </div>
                            </a>
                        </div>
                        <div class="d-flex justify-content-between">
                            <div>
                                ...
                                <h3
                                    ...
                                    <a href="" class="text-color-dark text-color-hover-primary">Product Short
                                        Name</a>
                                </h3>
                            </div>
                        </div>
                    ...
                    <div class="product mb-0">
                        <div class="product-thumb-info border-0 mb-3">
                            ...
                            <a href="shop-product-sidebar-left.html">
                                <div class="product-thumb-info-image bg-light">
                                    <img alt="" class="img-fluid"
                                        src="{{ asset('theme/default/img/products/product-2.jpg') }}">
                                </div>
                            </a>
                        </div>
                        <div class="d-flex justify-content-between">
                    ...
                    <div class="product mb-0">
                        <div class="product-thumb-info border-0 mb-3">
                            ...
                            <a href="shop-product-sidebar-left.html">
                                <div class="product-thumb-info-image bg-light">
                                    <img alt="" class="img-fluid"
                                        src="{{ asset('theme/default/img/products/product-3.jpg') }}">
                                </div>
                            </a>
                        </div>
                        <div class="d-flex justify-content-between">
                    ...
                    <div class="product mb-0">
                        <div class="product-thumb-info border-0 mb-3">
                            ...
                            <a href="shop-product-sidebar-left.html">
                                <div class="product-thumb-info-image bg-light">
                                    <img alt="" class="img-fluid"
                                        src="{{ asset('theme/default/img/products/product-4.jpg') }}">
                                </div>
                            </a>
                        </div>
                        <div class="d-flex justify-content-between">
            ...
            <div class="row">
                <div class="col text-center">
                    <a href="demo-auto-services-products.html"
                        class="btn btn-primary custom-btn-border-radius font-weight-bold text-3 btn-px-5 btn-py-3 appear-animation"
                        data-appear-animation="fadeInUpShorterPlus" data-appear-animation-delay="800">VIEW ALL
                        PRODUCTS</a>
                </div>
            </div>
        </div>
        ...
        <div class="container py-4">
            <div class="row align-items-center text-center py-5">
                <div class="col-sm-4 col-lg-2 mb-5 mb-lg-0">
                    <img src="{{ asset('theme/default/img/logos/logo-8.png') }}" alt class="img-fluid"
                        style="max-width: 90px;" />
                </div>
                <div class="col-sm-4 col-lg-2 mb-5 mb-lg-0">
                    <img src="{{ asset('theme/default/img/logos/logo-9.png') }}" alt class="img-fluid"
                        style="max-width: 140px;" />
                </div>
                <div class="col-sm-4 col-lg-2 mb-5 mb-lg-0">
                    <img src="{{ asset('theme/default/img/logos/logo-10.png') }}" alt class="img-fluid"
                        style="max-width: 140px;" />
                </div>
                <div class="col-sm-4 col-lg-2 mb-5 mb-sm-0">
                    <img src="{{ asset('theme/default/img/logos/logo-11.png') }}" alt class="img-fluid"
                        style="max-width: 140px;" />
                </div>
                <div class="col-sm-4 col-lg-2 mb-5 mb-sm-0">
                    <img src="{{ asset('theme/default/img/logos/logo-12.png') }}" alt class="img-fluid"
                        style="max-width: 100px;" />
                </div>
                <div class="col-sm-4 col-lg-2">
                    <img src="{{ asset('theme/default/img/logos/logo-13.png') }}" alt class="img-fluid"
                        style="max-width: 100px;" />
                </div>
            </div>
        </div>

...
class SystemLogsDataTable extends DataTable
{
    ...
    public function dataTable(LogReader $model)
    {
        ...
        return datatables()
            ...
            ->editColumn('context', function (Collection $model) {
                ...
                return view('pages.dashboard.log.system._details', compact('content'));
            })
            ->addColumn('action', function (Collection $model) {
                return view('pages.dashboard.log.system._action-menu', compact('model'));
            });
    }
    ...
    {
        return [
            Column::make('id')->title(trans('Log ID'))->width(100)->addClass('ps-0'),
            Column::make('message')->title(trans('Message')),
            Column::make('level')->title(trans('Level')),
            Column::make('date')->title(trans('Date'))->width(200),

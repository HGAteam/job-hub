            ...
            form,
            {
                fields: {
                    email: {
                        validators: {
                            notEmpty: {
                                message: `${lang.t('Email is required')}`
                            },
                            emailAddress: {
                    ...
                    password: {
                        validators: {
                            notEmpty: {
                                message: `${lang.t('Password is required')}`
                            }
                        }
                    }
                },
                ...
                if (status === 'Valid') {
                    ...
                    axios.post(form.getAttribute('action'), new FormData(form))
                        .then(function (response) {
                            ...
                            Swal.fire({
                                text: `${lang.t('Your email has been successfully changed')}.`,
                                icon: "success",
            ...
            form,
            {
                fields: {
                    current_password: {
                        validators: {
                            notEmpty: {
                                message: `${lang.t('Current Password is required')}`
                            }
                        }
                    },
                    ...
                    password: {
                        validators: {
                            notEmpty: {
                                message: `${lang.t('New Password is required')}`
                            }
                        }
                    },
                    ...
                    password_confirmation: {
                        validators: {
                            notEmpty: {
                                message: `${lang.t('Confirm Password is required')}`
                            },
                            identical: {
                                compare: function () {
                ...
                if (status == 'Valid') {
                    ...
                    axios.post(form.getAttribute('action'), new FormData(form))
                        .then(function (response) {
                            // Show message popup. For more info check the plugin's official documentation: https://sweetalert2.github.io/
                            Swal.fire({
                                text: `${lang.t("Your password has been successfully reset")}.`,
                                icon: "success",
                                buttonsStyling: false,
                                confirmButtonText: `${lang.t("Ok, got it!")}`,
                                customClass: {
